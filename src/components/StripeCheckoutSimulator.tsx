          ...
          <div className="p-4 sm:p-5 space-y-3 flex-1 overflow-y-auto">
            <div className="text-center space-y-1">
              <div className="flex items-center justify-center gap-2">
                <h3 className="text-base font-black text-slate-800 font-serif">Wybierz pakiet bajek</h3>
                <span className="inline-flex items-center gap-1 bg-[#635BFF]/10 text-[#635BFF] text-[9px] font-bold px-2 py-0.5 rounded-full font-mono">
                  <Lock size={9} /> SSL
                </span>
              </div>
              <p className="text-[11px] text-slate-400 font-sans">Zakupione bajki nigdy nie wygasają. Używaj w dowolnej chwili.</p>
            </div>
            ...
            <div className="space-y-2 max-h-[145px] overflow-y-auto pr-1">
              <button
                ...
                className={`w-full p-2.5 border-2 rounded-xl flex items-center justify-between text-left transition-all ${
                  selectedPlan === "one"
              ...
              >
                <div>
                  <h4 className="font-bold text-slate-700 text-xs flex items-center gap-1 font-sans">
                    Pakiet "Najpopularniejszy" <span className="text-[9px] bg-amber-100 text-amber-800 px-1.5 py-0.2 rounded-full font-serif font-bold">⭐</span>
                  </h4>
            ...
            <div className="space-y-1">
              <label className="block text-[9.5px] font-extrabold text-slate-500 uppercase tracking-wide font-sans">E-mail do wysyłki bajek i potwierdzenia</label>
              <input
                type="email"
                ...
                className="w-full bg-[#FAF9F6] px-3.5 py-2 border border-slate-200 rounded-xl text-xs font-bold text-slate-700 focus:outline-none focus:border-[#635BFF] font-sans transition-all"
              />
              {errorMsg && (
                <p className="text-[10px] text-rose-500 font-bold font-sans mt-0.5">
                  ⚠️ {errorMsg}
                </p>
              )}
            </div>
            ...
            <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-100 space-y-1.5 font-sans">
              <div className="flex items-center justify-between border-b border-slate-200/60 pb-1.5">
                <span className="text-[11px] text-slate-500 font-medium">Wybrana opcja:</span>
                <span className="text-[11px] font-bold text-slate-800">{plan?.name}</span>
              </div>
            ...
            <div className="space-y-2 px-1 font-sans">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="mt-0.5 w-3.5 h-3.5 rounded border-slate-300 text-[#635BFF] focus:ring-[#635BFF] cursor-pointer shrink-0"
                />
                <label htmlFor="terms-checkbox" className="text-[9.5px] leading-snug text-slate-600 font-medium cursor-pointer">
                  Zapoznałem/am się z{" "}
                  <a 
                    href="/regulamin" 
                    target="_blank" 
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="mt-0.5 w-3.5 h-3.5 rounded border-slate-300 text-[#635BFF] focus:ring-[#635BFF] cursor-pointer shrink-0"
                />
                <label htmlFor="immediate-checkbox" className="text-[9.5px] leading-snug text-slate-600 font-medium cursor-pointer">
            ...
            <div className="space-y-2.5 pt-1">
              <button
                ...
                className={`w-full py-3 px-4 rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 shadow-md transition-all duration-200 font-sans ${
              ...
              <div className="flex flex-col items-center gap-1.5 pt-0.5">
                <span className="text-[8.5px] text-slate-400 uppercase tracking-widest font-bold font-sans">Bezpieczna płatność obsługiwana przez Stripe:</span>
                <div className="flex items-center gap-2 flex-wrap justify-center">
                  {/* Stripe Badge */}
                  <div className="flex items-center gap-1 bg-[#635BFF]/10 px-1.5 py-0.5 rounded border border-[#635BFF]/20 shadow-xs">
                    <img src="/stripe-logo.jpg" alt="Stripe" className="h-3 w-auto rounded-xs object-cover" />
                    <span className="text-[8.5px] font-black text-[#635BFF] tracking-wider font-sans">STRIPE</span>
                  </div>
                  {/* BLIK Badge */}
                  <span className="text-[8.5px] font-black tracking-wider text-[#E30613] font-sans border-2 border-[#E30613] px-1.5 py-0.2 rounded-xs bg-rose-50/50 leading-tight">BLIK</span>
                  {/* VISA Logo */}
                  <svg className="h-2.5 w-auto opacity-70" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* MasterCard Logo */}
                  <svg className="h-3 w-auto opacity-70" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="text-[8.5px] font-extrabold text-slate-500 font-sans tracking-tight">Apple Pay / Google Pay / P24</span>
                </div>
              </div>
            </div>
          </div>
